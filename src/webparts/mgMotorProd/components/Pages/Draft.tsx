...
export const Draft: React.FC<IMgMotorProdProps> = (props: IMgMotorProdProps) => {
  ...
  const updateROForSubmit = async (nextApprover) => {
    ...
    const payload = {
      InitiatorNameId: UserId,
      InitiatorEmployeeID: props.EmployeeId[0]?.EmployeeID || null,
      Department: values.Department,
      Company: values.Company,
      Plant: values.Plant,
      ROFrom: values.ROFrom,
  ...
  const processROAction = async (
    action: ROAction,
    remarks: string,
    updatedPurpose?: string,  NextApprover?: string, DelegateApprover?: string
  ) => {
    try {
  ...
  const validateFormAndTable = async () => {
    ...
    const requiredFields = [
      ...
      {
        key: "ContractorScopeDescription",
        label: "Contractor Scope Description",
      },
                    ...
                    <tbody className="tbodylabel">
                      ...
                      <tr>
                        <td colSpan={3}>
                          ...
                          <Field name="POStartDate" className="form-control">
                            {/* {({ field }) => (
                              <input
                                {...field}
                                readOnly
                        ...
                        <td colSpan={3}>
                          ...
                          <Field name="POEndDate" className="form-control">
                            {/* {({ field }) => (
                              <input
                                {...field}
                                readOnly
