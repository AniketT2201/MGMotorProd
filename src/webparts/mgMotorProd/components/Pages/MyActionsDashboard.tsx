...
export const MyActionsDashboard: React.FC<IMgMotorProdProps> = (props: IMgMotorProdProps) => {
    ...
    const GetROData = async () => {
        ...
        const ROColl = await RORequestsOps().getIROData(
            ...
            props,
            `NextApproverEmpID eq ` + props.EmployeeId[0].EmployeeID
        );
            ...
            <div className="header">
                <div className="left-banner">
                    <div className="logo-text">
                        <h2>My Pending Actions Dashboard</h2>
                    </div>
                </div>
            </div>
                                        ...
                                        {paginatedData.map((item, index) => (
                                            <tr key={index} className="border-t">
                                                <td className="px-4 py-2">
                                                    <a
                                                        href={`${window.location.href.split('#')[0]}#/Draft?ItemId=${item.ID}&from=MyReqDash`}
...
export default MyActionsDashboard;
